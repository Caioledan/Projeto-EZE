...
class PathFinder:
    ...
    def find_shortest_path(self, start, end): #Função que acha o caminho mínimo entre o vértice de início e o vértice de fim
        ...
        visited = set() #Para fins de evitar um vértice já passado, os vértices visitados foram armazenados em uma lista.
